...
function newGame() {
  if (playGame) {
    ...
    $remainingCount.innerHTML = max_chance-numGuesses;
...
function checkGuess(guess) {
  if (validate(guess)) {
    if (numGuesses === max_chance && guess !== randomNumber) {
...
function displayGuesses(guess) {
  ...
  numGuesses++;
  // 구현 1. 남아기회를 보여줄 수 있도록 아래의 = 이후를 작성해주세요! 성공
  $remainingCount.innerHTML = max_chance - numGuesses;
}
