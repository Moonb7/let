...
console.log(`도시 ${start}에서 도시 ${end}까지 가는 최소 택시 요금은 ${cheapestCost}입니다.`);

// ## 알고리즘 핵심 아이디어
// - **점진적 탐색**
//     - 한 번에 모든 경로를 계산하지 않고, 현재 위치에서 갈 수 있는 곳만 확인해요!
// - **최선의 선택**
//     - 항상 현재 알고 있는 가장 저렴한 경로를 선택하죠!
// - **정보 업데이트**
//     - 새로운 경로를 발견할 때마다 비용 정보를 업데이트합니다.
// 이런 방식으로 모든 가능한 경로를 효율적으로 탐색하면서 최적의 경로를 찾아가는 것이라고 생각하시면 됩니다!
